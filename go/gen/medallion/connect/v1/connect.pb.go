...
const (
	...
	EventKind_EVENT_KIND_CDC EventKind = 1
	// Audit-trail event.
	EventKind_EVENT_KIND_AUDIT EventKind = 2
)
...
type CdcEvent struct {
	...
	Kind EventKind `protobuf:"varint,16,opt,name=kind,proto3,enum=medallion.connect.v1.EventKind" json:"kind,omitempty"`
	...
	// medallion-connect.
	IngestedByPrincipal string `protobuf:"bytes,19,opt,name=ingested_by_principal,json=ingestedByPrincipal,proto3" json:"ingested_by_principal,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *CdcEvent) GetKind() EventKind {
	if x != nil {
		return x.Kind
	}
...
func (x *CdcEvent) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
type ListCdcEventsRequest struct {
	...
	Kind EventKind `protobuf:"varint,6,opt,name=kind,proto3,enum=medallion.connect.v1.EventKind" json:"kind,omitempty"`
	...
	OccurredAtFrom *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=occurred_at_from,json=occurredAtFrom,proto3" json:"occurred_at_from,omitempty"`
	// Optional exclusive occurred_at upper bound.
	OccurredAtTo *timestamppb.Timestamp `protobuf:"bytes,10,opt,name=occurred_at_to,json=occurredAtTo,proto3" json:"occurred_at_to,omitempty"`
	// Optional source system filter.
	SourceSystem string `protobuf:"bytes,11,opt,name=source_system,json=sourceSystem,proto3" json:"source_system,omitempty"`
	// Optional source stream/table/topic filter.
	StreamName string `protobuf:"bytes,12,opt,name=stream_name,json=streamName,proto3" json:"stream_name,omitempty"`
	// Cursor returned by a previous ListCdcEventsResponse.
	PageCursor string `protobuf:"bytes,13,opt,name=page_cursor,json=pageCursor,proto3" json:"page_cursor,omitempty"`
	// Optional authenticated ingester principal filter.
	IngestedByPrincipal string `protobuf:"bytes,14,opt,name=ingested_by_principal,json=ingestedByPrincipal,proto3" json:"ingested_by_principal,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ListCdcEventsRequest) GetKind() EventKind {
	if x != nil {
		return x.Kind
	}
	return EventKind_EVENT_KIND_UNSPECIFIED
...
func (x *ListCdcEventsRequest) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
const file_medallion_connect_v1_connect_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\x93\x06\n" +
	"\bCdcEvent\x12\x0e\n" +
	...
	"\x04kind\x18\x10 \x01(\x0e2\x1f.medallion.connect.v1.EventKindR\x04kind\x12\x16\n" +
	"\x06action\x18\x11 \x01(\tR\x06action\x12#\n" +
	"\rsource_system\x18\x12 \x01(\tR\fsourceSystem\x122\n" +
	"\x15ingested_by_principal\x18\x13 \x01(\tR\x13ingestedByPrincipal\"\xf1\x04\n" +
	...
	"\x06events\x18\x03 \x03(\v2'.medallion.connect.v1.PublishedCdcEventR\x06events\"\xd8\x04\n" +
	...
	"\x05limit\x18\x05 \x01(\rR\x05limit\x123\n" +
	"\x04kind\x18\x06 \x01(\x0e2\x1f.medallion.connect.v1.EventKindR\x04kind\x12'\n" +
	"\x0factor_principal\x18\a \x01(\tR\x0eactorPrincipal\x12\x16\n" +
	"\x06action\x18\b \x01(\tR\x06action\x12D\n" +
	"\x10occurred_at_from\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x0eoccurredAtFrom\x12@\n" +
	"\x0eoccurred_at_to\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\foccurredAtTo\x12#\n" +
	"\rsource_system\x18\v \x01(\tR\fsourceSystem\x12\x1f\n" +
	"\vstream_name\x18\f \x01(\tR\n" +
	"streamName\x12\x1f\n" +
	"\vpage_cursor\x18\r \x01(\tR\n" +
	"pageCursor\x122\n" +
	"\x15ingested_by_principal\x18\x0e \x01(\tR\x13ingestedByPrincipal\"y\n" +
	...
	"\x16CDC_OPERATION_SNAPSHOT\x10\x04*Q\n" +
	"\tEventKind\x12\x1a\n" +
	"\x16EVENT_KIND_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eEVENT_KIND_CDC\x10\x01\x12\x14\n" +
	"\x10EVENT_KIND_AUDIT\x10\x02*\xd5\x01\n" +
	...
	"\x1eACTION_EXECUTION_STATUS_FAILED\x10\x042\xd9\t\n" +
...
var file_medallion_connect_v1_connect_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_medallion_connect_v1_connect_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_medallion_connect_v1_connect_proto_goTypes = []any{
	...
	(EventKind)(0),                          // 2: medallion.connect.v1.EventKind
	(ActionExecutionStatus)(0),              // 3: medallion.connect.v1.ActionExecutionStatus
	(*Connector)(nil),                       // 4: medallion.connect.v1.Connector
	(*CdcEvent)(nil),                        // 5: medallion.connect.v1.CdcEvent
...
var file_medallion_connect_v1_connect_proto_depIdxs = []int32{
	...
	29, // 1: medallion.connect.v1.Connector.created_at:type_name -> google.protobuf.Timestamp
	29, // 2: medallion.connect.v1.Connector.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 3: medallion.connect.v1.CdcEvent.operation:type_name -> medallion.connect.v1.CdcOperation
	29, // 4: medallion.connect.v1.CdcEvent.occurred_at:type_name -> google.protobuf.Timestamp
	29, // 5: medallion.connect.v1.CdcEvent.observed_at:type_name -> google.protobuf.Timestamp
	2,  // 6: medallion.connect.v1.CdcEvent.kind:type_name -> medallion.connect.v1.EventKind
	0,  // 7: medallion.connect.v1.ConnectorAction.status:type_name -> medallion.connect.v1.LifecycleStatus
	29, // 8: medallion.connect.v1.ConnectorAction.created_at:type_name -> google.protobuf.Timestamp
	29, // 9: medallion.connect.v1.ConnectorAction.updated_at:type_name -> google.protobuf.Timestamp
	3,  // 10: medallion.connect.v1.ActionExecution.status:type_name -> medallion.connect.v1.ActionExecutionStatus
	29, // 11: medallion.connect.v1.ActionExecution.started_at:type_name -> google.protobuf.Timestamp
	29, // 12: medallion.connect.v1.ActionExecution.completed_at:type_name -> google.protobuf.Timestamp
	4,  // 13: medallion.connect.v1.RegisterConnectorResponse.connector:type_name -> medallion.connect.v1.Connector
	4,  // 14: medallion.connect.v1.ListConnectorsResponse.connectors:type_name -> medallion.connect.v1.Connector
	4,  // 15: medallion.connect.v1.DisableConnectorResponse.connector:type_name -> medallion.connect.v1.Connector
	6,  // 16: medallion.connect.v1.RegisterConnectorActionResponse.action:type_name -> medallion.connect.v1.ConnectorAction
	6,  // 17: medallion.connect.v1.ListConnectorActionsResponse.actions:type_name -> medallion.connect.v1.ConnectorAction
	6,  // 18: medallion.connect.v1.DisableConnectorActionResponse.action:type_name -> medallion.connect.v1.ConnectorAction
	7,  // 19: medallion.connect.v1.ExecuteConnectorActionResponse.execution:type_name -> medallion.connect.v1.ActionExecution
	7,  // 20: medallion.connect.v1.GetActionExecutionResponse.execution:type_name -> medallion.connect.v1.ActionExecution
	5,  // 21: medallion.connect.v1.PublishCdcEventsRequest.events:type_name -> medallion.connect.v1.CdcEvent
	25, // 22: medallion.connect.v1.PublishCdcEventsResponse.events:type_name -> medallion.connect.v1.PublishedCdcEvent
	2,  // 23: medallion.connect.v1.ListCdcEventsRequest.kind:type_name -> medallion.connect.v1.EventKind
	29, // 24: medallion.connect.v1.ListCdcEventsRequest.occurred_at_from:type_name -> google.protobuf.Timestamp
	29, // 25: medallion.connect.v1.ListCdcEventsRequest.occurred_at_to:type_name -> google.protobuf.Timestamp
	5,  // 26: medallion.connect.v1.ListCdcEventsResponse.events:type_name -> medallion.connect.v1.CdcEvent
	8,  // 27: medallion.connect.v1.MedallionConnectService.RegisterConnector:input_type -> medallion.connect.v1.RegisterConnectorRequest
	10, // 28: medallion.connect.v1.MedallionConnectService.ListConnectors:input_type -> medallion.connect.v1.ListConnectorsRequest
	12, // 29: medallion.connect.v1.MedallionConnectService.DisableConnector:input_type -> medallion.connect.v1.DisableConnectorRequest
	14, // 30: medallion.connect.v1.MedallionConnectService.RegisterConnectorAction:input_type -> medallion.connect.v1.RegisterConnectorActionRequest
	16, // 31: medallion.connect.v1.MedallionConnectService.ListConnectorActions:input_type -> medallion.connect.v1.ListConnectorActionsRequest
	18, // 32: medallion.connect.v1.MedallionConnectService.DisableConnectorAction:input_type -> medallion.connect.v1.DisableConnectorActionRequest
	20, // 33: medallion.connect.v1.MedallionConnectService.ExecuteConnectorAction:input_type -> medallion.connect.v1.ExecuteConnectorActionRequest
	22, // 34: medallion.connect.v1.MedallionConnectService.GetActionExecution:input_type -> medallion.connect.v1.GetActionExecutionRequest
	24, // 35: medallion.connect.v1.MedallionConnectService.PublishCdcEvents:input_type -> medallion.connect.v1.PublishCdcEventsRequest
	27, // 36: medallion.connect.v1.MedallionConnectService.ListCdcEvents:input_type -> medallion.connect.v1.ListCdcEventsRequest
	9,  // 37: medallion.connect.v1.MedallionConnectService.RegisterConnector:output_type -> medallion.connect.v1.RegisterConnectorResponse
	11, // 38: medallion.connect.v1.MedallionConnectService.ListConnectors:output_type -> medallion.connect.v1.ListConnectorsResponse
	13, // 39: medallion.connect.v1.MedallionConnectService.DisableConnector:output_type -> medallion.connect.v1.DisableConnectorResponse
	15, // 40: medallion.connect.v1.MedallionConnectService.RegisterConnectorAction:output_type -> medallion.connect.v1.RegisterConnectorActionResponse
	17, // 41: medallion.connect.v1.MedallionConnectService.ListConnectorActions:output_type -> medallion.connect.v1.ListConnectorActionsResponse
	19, // 42: medallion.connect.v1.MedallionConnectService.DisableConnectorAction:output_type -> medallion.connect.v1.DisableConnectorActionResponse
	21, // 43: medallion.connect.v1.MedallionConnectService.ExecuteConnectorAction:output_type -> medallion.connect.v1.ExecuteConnectorActionResponse
	23, // 44: medallion.connect.v1.MedallionConnectService.GetActionExecution:output_type -> medallion.connect.v1.GetActionExecutionResponse
	26, // 45: medallion.connect.v1.MedallionConnectService.PublishCdcEvents:output_type -> medallion.connect.v1.PublishCdcEventsResponse
	28, // 46: medallion.connect.v1.MedallionConnectService.ListCdcEvents:output_type -> medallion.connect.v1.ListCdcEventsResponse
